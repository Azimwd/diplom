...
KZ_DOCUMENT_TITLES = {
    ...
    "Доверенность на представительство в Конституционном Суде.docx": "Конституциялық Сотта өкілдік етуге арналған сенімхат",
    ...
    "Ходатаство в суд об ознакомлении с материалами дела.docx": "Сотта іс материалдарымен танысу туралы өтінішхат",
    ...
    "Претензия о замене некачественного товара.docx": "Сапасыз тауарды ауыстыру туралы тұтынушының наразылығы",
    "Претензия о замене товара ненадлежащего качества.docx": "Сапасы тиісті емес тауарды ауыстыру туралы наразылық",
    "Исковое заявление об изменении размера алиментов.docx": "Алимент мөлшерін өзгерту туралы талап қою арызы",
    "Исковое заявление о взыскании материального ущерба.docx": "Материалдық залалды өндіру туралы талап қою арызы",
    ...
    "Иск об устранении нарушений, не связанных с лишением владения.docx": "Иеленуден айырумен байланысты емес құқық бұзушылықтарды жою туралы талап қою",
    "Иск об истребовании имущества из чужого незаконного владения.docx": "Мүлікті бөтеннің заңсыз иеленуінен талап ету туралы талап қою",
    "Иск о прекращении права собственности.docx": "Меншік құқығын тоқтату туралы талап қою",
    "Иск о признании недействительным договора и взыскании суммы.docx": "Шартты жарамсыз деп тану және соманы өндіру туралы талап қою",
    ...
    "Иск о признании права собственности по приобретательной давности.docx": "Иелену мерзіміне байланысты меншік құқығын тану туралы талап қою",
    ...
    "Иск о восстановлении срока для принятия наследства (2).docx": "Мұраны қабылдау мерзімін қалпына келтіру туралы талап қою",
    ...
    "Иск о возмещении вреда, причиненного повреждением здоровья.docx": "Денсаулыққа зиян келтіруден туындаған зиянды өтеу туралы талап қою",
    "Иск о выселении.docx": "Көшіру туралы талап қою",
    "Иск о взыскании заработной платы.docx": "Жалақыны өндіру туралы талап қою",
    "Иск о взыскании средств на содержание родителя.docx": "Ата-ананы асырауға қаражат өндіру туралы талап қою",
    "Иск о взыскании задолженности.docx": "Берешекті өндіру туралы талап қою",
    "Иск о взыскании задолженности по договору.docx": "Шарт бойынша берешекті өндіру туралы талап қою",
    "Иск о взыскании задолженности по договору аренды.docx": "Жалдау шарты бойынша берешекті өндіру туралы талап қою",
    ...
    "Заявление о признании гражданина ограниченно дееспособным.docx": "Азаматты әрекет қабілеті шектеулі деп тану туралы арыз",
    "Заявление о возврате иска.docx": "Талап қою арызын қайтару туралы арыз",
    "Иск о восстановлении на работе и взыскании заработной платы.docx": "Жұмысқа қайта орналастыру және жалақыны өндіру туралы талап қою",
    "Иск о восстановлении на работе и взыскании премии.docx": "Жұмысқа қайта орналастыру және сыйақыны өндіру туралы талап қою",
    "Иск о взыскании алиментов в твердой денежной сумме.docx": "Тұрақты ақша сомасында алимент өндіру туралы талап қою",
    "Иск о взыскании алиментов за прошедший период в твердой денежной сумме.docx": "Өткен кезең үшін тұрақты ақша сомасында алимент өндіру туралы талап қою",
    "Иск об отмене приказа об увольнении и восстановлении на работе.docx": "Жұмыстан босату туралы бұйрықтың күшін жою және жұмысқа қайта орналастыру туралы талап қою",
    "Иск об установлении отцовства и взыскании алиментов.docx": "Әкелікті анықтау және алимент өндіру туралы талап қою",
    "Заявление о взыскании алиментов.docx": "Алимент өндіру туралы арыз"
}
