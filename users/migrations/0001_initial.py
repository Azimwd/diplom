    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('user', 'пользователь')], default='user', max_length=10, verbose_name='role')),
                ('agreementAccepted', models.BooleanField(default=False)),
                ('privacyPolicyAccepted', models.BooleanField(default=False)),
                ('agreementVersion', models.CharField(blank=True, max_length=10, null=True)),
